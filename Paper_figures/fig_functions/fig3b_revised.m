...
for time = 1:length(T)
    ...
    for ii = 1:ntrials
        ...
        for kk = 1:length(model_order_vals)
            ...
            model_true.cntrl_pts  =[0 5:5:model_order];
...
barplot(Labels,accuracy_stand(:,1,1),accuracy_stand(:,2,1),accuracy_stand(:,1,2),accuracy_stand(:,2,2),accuracy_stand(:,1,3),accuracy_stand(:,2,3))
...
ax1=subplot(2,2,3);
barplot(Labels,time_results_standard(:,1,1),time_results_standard(:,2,1),time_results_standard(:,1,2),time_results_standard(:,2,2),time_results_standard(:,1,3),time_results_standard(:,2,3))
...
barplot(Labels,accuracy_spline(:,1,1),accuracy_spline(:,2,1),accuracy_spline(:,1,2),accuracy_spline(:,2,2),accuracy_spline(:,1,3),accuracy_spline(:,2,3))
...
ax2= subplot(2,2,4);
barplot(Labels,time_results_spline(:,1,1),time_results_spline(:,2,1),time_results_spline(:,1,2),time_results_spline(:,2,2),time_results_spline(:,1,3),time_results_spline(:,2,3))
